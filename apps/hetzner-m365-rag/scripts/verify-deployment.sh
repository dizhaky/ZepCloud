#!/bin/bash
# Deployment Verification Script for M365 RAG System
...
LOG_FILE="/var/log/m365-rag-verify.log"
...
generate_status_report() {
    ...
    local report_file="/tmp/m365-rag-status-report-$(date +%Y%m%d-%H%M%S).txt"
    
    {
        echo "M365 RAG System Status Report"
        echo "Generated: $(date)"
        echo "========================================"
        echo ""
...
main() {
    echo -e "${BLUE}╔══════════════════════════════════════════════════════════════════════════════╗${NC}"
    echo -e "${BLUE}║                    M365 RAG System Verification                              ║${NC}"
    echo -e "${BLUE}╚══════════════════════════════════════════════════════════════════════════════╝${NC}"
    echo ""
    ...
    touch "$LOG_FILE"
    log "Starting M365 RAG System verification"
